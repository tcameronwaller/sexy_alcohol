...
path_directory_source="${path_directory_dock}/alcohol_genetics_tcw_2023-03-02/gwas_format_standard"
path_directory_product="${path_directory_dock}/alcohol_genetics_tcw_2023-03-02/gwas_format_ldsc"
