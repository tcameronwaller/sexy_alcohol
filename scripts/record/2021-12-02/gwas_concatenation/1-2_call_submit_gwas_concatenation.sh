...
cohorts_models="cohorts_models_linear_measurement_unadjust" # 36 GWAS; TCW started at ___ on 1 December 2021
...
path_gwas_source_container="${path_dock}/gwas_raw_no_x/${cohorts_models}"
path_gwas_target_container="${path_dock}/gwas_concatenation_no_x/${cohorts_models}"

path_scripts_record="$path_process/sexy_alcohol/scripts/record/2021-12-02/gwas_concatenation_no_x"
