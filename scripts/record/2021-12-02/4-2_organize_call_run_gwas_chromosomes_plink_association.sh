...
# Organize variables.
cohort_model_phenotype="${cohort_model}_${phenotypes}"
path_study_gwas="${path_gwas}/${cohort_model_phenotype}"
path_table_phenotypes_covariates="${path_cohorts_models}/${table_cohort_model}_${phenotypes}.tsv"
...
echo "path to gwas: " ${path_study_gwas}
