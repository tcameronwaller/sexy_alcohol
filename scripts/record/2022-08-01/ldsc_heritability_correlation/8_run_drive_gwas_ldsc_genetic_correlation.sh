...
path_script_estimate_ldsc_genetic_correlation="${path_promiscuity_scripts}/utility/ldsc/estimate_gwas_genetic_correlation_ldsc.sh"
/usr/bin/bash "$path_script_estimate_ldsc_genetic_correlation" \
