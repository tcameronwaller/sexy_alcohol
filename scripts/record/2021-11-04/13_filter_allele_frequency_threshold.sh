...
path_target_report="${path_allele_frequency}/allele_frequency_filter_0_001.afreq"
path_target_report_compress="${path_allele_frequency}/allele_frequency_filter_0_001.afreq.gz"
...
threshold_allele_frequency=0.001 # threshold filter by minor allele frequency
