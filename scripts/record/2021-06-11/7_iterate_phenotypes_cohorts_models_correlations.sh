...
path_scripts_record="$path_process/sexy_alcohol/scripts/record/2021-06-11"

path_dock="$path_process/dock"
path_genetic_reference="${path_dock}/access/genetic_reference"
path_gwas="${path_dock}/gwas"
path_gwas_cohorts_models="${path_gwas}/cohorts_models_2021-06-07"
...
if true; then
  ...
  #pairs+=("female_albumin_log;male_albumin_log")
  #pairs+=("female_premenopause_ordinal_albumin_log;male_albumin_log")
  #pairs+=("female_perimenopause_ordinal_albumin_log;male_albumin_log")
  #pairs+=("female_postmenopause_ordinal_albumin_log;male_albumin_log")
  #pairs+=("female_premenopause_ordinal_albumin_log;male_young_albumin_log")
  ...
  #pairs+=("female_perimenopause_ordinal_oestradiol_log;male_oestradiol_log")
  #pairs+=("female_postmenopause_ordinal_oestradiol_log;male_oestradiol_log")
  #pairs+=("female_premenopause_ordinal_oestradiol_log;male_young_oestradiol_log")
  ...
  #pairs+=("female_perimenopause_ordinal_vitamin_d_log;male_vitamin_d_log")
  #pairs+=("female_postmenopause_ordinal_vitamin_d_log;male_vitamin_d_log")
