...
path_scripts="$path_waller/sexy_alcohol/scripts/record/2021-03-18"
...
# Cohort: (covariates)
# female_male (genotypes, sex, age, body_mass_index_log)
# female (genotypes, age, body_mass_index_log, menopause, oral_contraception, hormone_therapy)
# female_premenopause (genotypes, age, body_mass_index_log, menstruation_day, oral_contraception, hormone_therapy)
# female_postmenopause (genotypes, age, body_mass_index_log, oral_contraception, hormone_therapy)
# male
