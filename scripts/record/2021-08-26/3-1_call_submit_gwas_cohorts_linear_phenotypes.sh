...
#path_gwas="${path_dock}/gwas/cohorts_models_linear_order"                # __ GWAS; TCW started at ___ on 3 September 2021
path_gwas="${path_dock}/gwas/cohorts_models_linear_order_unadjust"       # __ GWAS; TCW started at ___ on __ September 2021 <-- next
