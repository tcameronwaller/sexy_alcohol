...
path_scripts_record="$path_process/sexy_alcohol/scripts/record/2021-08-26/fill_chromosome_x"
path_dock="$path_process/dock_2021-08-26"
...
#path_gwas="${path_dock}/gwas/cohorts_models_linear_measurement"          # 72 GWAS; TCW started at 14:51 on 27 October 2021
#path_gwas="${path_dock}/gwas/cohorts_models_linear_measurement_unadjust" # 72 GWAS; TCW started at ___ on ___
path_gwas="${path_dock}/gwas/cohorts_models_linear_imputation"           # 72 GWAS; TCW started at ___ on 27 October 2021
#path_gwas="${path_dock}/gwas/cohorts_models_linear_imputation_unadjust"  # 63 GWAS; TCW started at ___ on ___

#path_gwas="${path_dock}/gwas/cohorts_models_logistic_detection"          # 63 GWAS; TCW started at ___ on ___
#path_gwas="${path_dock}/gwas/cohorts_models_logistic_detection_unadjust" # 63 GWAS; TCW started at ___ on ___

# TODO: TCW 27 October 2021
# Too complex... consider dropping?
#path_gwas="${path_dock}/gwas/cohorts_models_linear_order"                # 40 GWAS; TCW started at ___ on 7 September 2021
#path_gwas="${path_dock}/gwas/cohorts_models_linear_order_unadjust"       # 40 GWAS; TCW started at ___ on 7 September 2021
...
path_batch_instances="${path_gwas}/batch_instances_fill_x.txt"
...
if true; then
  ...
  -o "${path_gwas}/out_fill_x.txt" -e "${path_gwas}/error_fill_x.txt" \
