...
path_gwas="${path_dock}/gwas/cohorts_models_linear_measurement"          # 72 GWAS; TCW started at ___ on ___
#path_gwas="${path_dock}/gwas/cohorts_models_linear_measurement_unadjust" # 72 GWAS; TCW started at ___ on ___
#path_gwas="${path_dock}/gwas/cohorts_models_linear_imputation"           # 63 GWAS; TCW started at ___ on ___
