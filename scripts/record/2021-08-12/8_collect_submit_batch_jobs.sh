...
path_storage=$(<"./storage_waller_metabolism.txt")
path_gwas_source_container="${path_storage}/share/2021-08-12_oestradiol_testosterone_gwas/gwas/cohorts_models" # selection
path_gwas_target_container="${path_storage}/share/2021-08-12_oestradiol_testosterone_gwas/gwas_process/cohorts_models" # selection

# Note:
# Per current implementation, it is essential that "path_gwas_source_container"
# is not the same as "path_gwas_target_container".
...
if true; then
  ...
  "${path_scripts_record}/9_run_batch_jobs_gwas_concatenation.sh" \
